...
**No half-built features. No deferred scope.** Build every feature to be the best it can
be, end-to-end, the first time. If while working you find a problem or security risk —
however small — **fix it now**; do not save it for a "later pass." Deferring scope grows a
never-ending TODO list and forces rediscovery of known gaps during slow (~40-min) package
