    ...
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        <div className="bg-muted/30 px-4 py-3 border-b flex items-center justify-between">
          ...
          <HowToTooltip title="Close Editor" description="Close the identity card popover." side="bottom">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex gap-1.5">
              <Input
                ...
                className="h-8 text-sm"
              />
              <HowToTooltip title="Add Skill" description="Add this skill to your peer identity." side="bottom">
                <Button
                  size="icon"
                  variant="secondary"
            ...
            {card.skills.length > 0 && (
              <div className="flex flex-wrap gap-1">
                {card.skills.map((skill) => (
                  <HowToTooltip key={skill} title="Remove Skill" description="Remove this skill from your profile." side="top">
                    <Badge
                      variant="secondary"
