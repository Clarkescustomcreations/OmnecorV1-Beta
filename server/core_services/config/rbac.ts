...
export const ROLE_PERMISSIONS: Record<Role, Permission[]> = {
  // Paired phone: can use the assistant (including the tool-running agentic
  // chat + Run-code, which the APK is built around) and read the
  // dashboard/settings, but cannot write settings, manage users, configure the
  // system, or set sovereign mode. adminProcedure/ownerProcedure reject it
  // outright (role !== admin/owner).
  device: [
